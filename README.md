...
|  sudo apt install libusb-1.0-0-dev            |  type this in the terminal for the Linux driver                                                                        |

> 📥 If you want to join the Telegram group for the Transsion Unisoc Series forum, click the link below > [Telegram](https://t.me/forumitelindonesia).
